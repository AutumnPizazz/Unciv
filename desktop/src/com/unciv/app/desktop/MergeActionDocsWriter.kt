...
/** Auto-generates the MergeAction modder documentation.
 *  Called from [DesktopLauncher.main] when not run from JAR. */
class MergeActionDocsWriter {
    companion object {
        private const val outputFileName = "../../docs/Modders/Mod-file-structure/6-MergeActions.md"
    }
