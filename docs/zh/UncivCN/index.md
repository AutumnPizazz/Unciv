...
- 当前版本：**4.21.5.1**（基于上游 4.21.5）

## 与上游的关系

- **同步跟进**：定期将上游 master 合并进 UncivCN，游戏版本号保持 `上游版本 + .1` 后缀（如 4.21.5 → 4.21.5.1），始终基于最新上游开发
...
| 类别 | 特性 |
|---|---|
| 联机 | [轮询联机](../更新日志/UncivCN/轮询联机.md)、默认服务器（sp.unciv.cn）、联机禁用读档随机数 |
