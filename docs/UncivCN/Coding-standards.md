...
- **Every mod change (feature / bugfix / CI / docs) must also update the docs-site mod section changelog** `docs/Community/Mods/CoeHarMod/更新日志/index.md` and its Chinese copy `docs/zh/Community/Mods/CoeHarMod/更新日志/index.md` (EN + ZH): add one line to the **Unreleased** section at the top of each (EN in English, ZH in Chinese)
