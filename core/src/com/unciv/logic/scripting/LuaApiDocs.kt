...
object LuaApiDocs {
    ...
    private val civEntries = listOf(
        ...
        q("getVariable", "fun(variableName: string): number", "Mod-defined variable value (ruleset default when unset)", "模组变量值（未设置时返回默认值）"),
        q("getVariables", "fun(): table", "Table {variableName = amount}", "变量表 {变量名 = 数量}"),
        ...
        w("setVariable", "fun(variableName: string, amount: number)", "Set a mod-defined variable to exactly this amount", "将模组变量设为精确值"),
        w("addVariable", "fun(variableName: string, amount: number)", "Add to a mod-defined variable", "增加模组变量"),
    ...
    private val unitEntries = listOf(
        ...
        q("getVariable", "fun(variableName: string): number", "Unit-scope variable value", "单位级变量值"),
        w("setVariable", "fun(variableName: string, amount: number)", "Set a unit-scope variable (clamped to its bounds)", "设置单位级变量（受上下限约束）"),
        w("addVariable", "fun(variableName: string, amount: number)", "Add to a unit-scope variable (clamped to its bounds)", "增加单位级变量（受上下限约束）"),
        q("getVariables", "fun(): table", "Table {variableName = amount} of this unit's unit-scope variables", "单位变量表 {变量名 = 数量}"),
        ...
        q("getAttackingStrengthAgainst", "fun(x: number, y: number): number", "Predicted final attack strength against the unit/city at a tile (0 if none)", "对指定坐标单位/城市的预计最终攻击力（无目标为 0）"),
        q("getDefendingStrengthAgainst", "fun(x: number, y: number): number", "Predicted final defence strength against the attacker at a tile (0 if none)", "对指定坐标攻击者的预计最终防御力（无目标为 0）"),
        q("predictDamageTo", "fun(x: number, y: number): number", "Predicted damage dealt to the unit/city at a tile (0 if none)", "对指定坐标单位/城市的预计伤害（无目标为 0）"),
        q("predictDamageFrom", "fun(x: number, y: number): number", "Predicted counter-damage received from the unit/city at a tile (0 if none)", "来自指定坐标单位/城市的预计反击伤害（无目标为 0）"),
